...
<body>
    <header>
        <h1>Product List</h1>
        <input type="button" onclick="window.location.href='addproduct.php';" value="ADD" class="btn btn-outline-primary">
        <input type="submit" name="massDelete" id="delete-product-btn" value="MASS DELETE" form="item_form" class="btn btn-outline-secondary">
    </header>
